  ...
  internal = rec {
    ...
    crates = {
      ...
      "hash-file" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./hash-file; };
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
      ...
      "hash-folder" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./hash-folder; };
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
      ...
      "hasher" = rec {
        ...
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./hasher; };
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
